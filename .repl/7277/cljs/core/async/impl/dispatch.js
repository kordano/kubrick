...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13455 = 0;while(true){
var m_13456 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13456 == null))
{} else
{m_13456.call(null);
if((count_13455 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13457 = (count_13455 + 1);
count_13455 = G__13457;
continue;
}
} else
{}
