...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13461 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t13461');

/**
* @constructor
*/
cljs.core.async.impl.channels.t13461 = (function (val,box,meta13462){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13461.cljs$lang$type = true;
cljs.core.async.impl.channels.t13461.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13461";
cljs.core.async.impl.channels.t13461.cljs$lang$ctorPrWriter = (function (this__6727__auto__,writer__6728__auto__,opt__6729__auto__){return cljs.core._write.call(null,writer__6728__auto__,"cljs.core.async.impl.channels/t13461");
});
cljs.core.async.impl.channels.t13461.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t13461.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13463){var self__ = this;
return self__.meta13462;
});
cljs.core.async.impl.channels.t13461.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13463,meta13462__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t13461(self__.val,self__.box,meta13462__$1));
});
cljs.core.async.impl.channels.__GT_t13461 = (function __GT_t13461(val__$1,box__$1,meta13462){return (new cljs.core.async.impl.channels.t13461(val__$1,box__$1,meta13462));
});
}
return (new cljs.core.async.impl.channels.t13461(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6730__auto__,writer__6731__auto__,opts__6732__auto__){return cljs.core._write.call(null,writer__6731__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6727__auto__,writer__6728__auto__,opt__6729__auto__){return cljs.core._write.call(null,writer__6728__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13464 = self__.takes.pop();if((taker_13464 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13464))
{var take_cb_13465 = cljs.core.async.impl.protocols.commit.call(null,taker_13464);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13465,taker_13464){
return (function (){return take_cb_13465.call(null,null);
});})(take_cb_13465,taker_13464))
);
} else
{}
{
