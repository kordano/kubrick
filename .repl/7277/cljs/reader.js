...
{var x__6790__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.read_char[goog.typeOf(x__6790__auto__)]);if(or__3943__auto__)
...
{var x__6790__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.unread[goog.typeOf(x__6790__auto__)]);if(or__3943__auto__)
{return or__3943__auto__;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__6727__auto__,writer__6728__auto__,opt__6729__auto__){return cljs.core._write.call(null,writer__6728__auto__,"cljs.reader/StringPushbackReader");
});
...
reader_error.cljs$lang$applyTo = (function (arglist__10959){
var rdr = cljs.core.first(arglist__10959);
var msg = cljs.core.rest(arglist__10959);
...
{{
var G__10960 = (function (){sb.append(ch);
return sb;
})();
var G__10961 = cljs.reader.read_char.call(null,rdr);
sb = G__10960;
ch = G__10961;
continue;
}
...
{{
var G__10964 = cljs.reader.read_char.call(null,rdr);
ch = G__10964;
continue;
}
} else
...
var G__10965 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__10965;
continue;
}
} else
...
var G__10966 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__10966;
continue;
}
}
...
{{
var G__10972 = (function (){buffer.append(ch);
return buffer;
})();
...
{if(("\\" === ch))
{{
var G__10974 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__10976 = (function (){buffer.append(ch);
return buffer;
})();
var G__10977 = cljs.reader.read_char.call(null,reader);
buffer = G__10976;
ch = G__10977;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__10982 = o;if(G__10982)
{if((function (){var or__3943__auto__ = (G__10982.cljs$lang$protocol_mask$partition0$ & 262144);if(or__3943__auto__)
{return or__3943__auto__;
} else
{return G__10982.cljs$core$IWithMeta$;
}
})())
{return true;
} else
{if((!G__10982.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__10982);
} else
{return false;
}
}
...
{{
var G__10988 = cljs.reader.read_comment.call(null,reader,ch);
var G__10989 = eof_is_error;
var G__10990 = sentinel;
var G__10991 = is_recursive;
reader = G__10988;
eof_is_error = G__10989;
sentinel = G__10990;
is_recursive = G__10991;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__10992 = reader;
var G__10993 = eof_is_error;
var G__10994 = sentinel;
var G__10995 = is_recursive;
reader = G__10992;
eof_is_error = G__10993;
sentinel = G__10994;
is_recursive = G__10995;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__10998 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__10998,0,null);var years = cljs.core.nth.call(null,vec__10998,1,null);var months = cljs.core.nth.call(null,vec__10998,2,null);var days = cljs.core.nth.call(null,vec__10998,3,null);var hours = cljs.core.nth.call(null,vec__10998,4,null);var minutes = cljs.core.nth.call(null,vec__10998,5,null);var seconds = cljs.core.nth.call(null,vec__10998,6,null);var fraction = cljs.core.nth.call(null,vec__10998,7,null);var offset_sign = cljs.core.nth.call(null,vec__10998,8,null);var offset_hours = cljs.core.nth.call(null,vec__10998,9,null);var offset_minutes = cljs.core.nth.call(null,vec__10998,10,null);var v = vec__10998;if(cljs.core.not.call(null,v))
...
{var vec__11000 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__11000,0,null);var months = cljs.core.nth.call(null,vec__11000,1,null);var days = cljs.core.nth.call(null,vec__11000,2,null);var hours = cljs.core.nth.call(null,vec__11000,3,null);var minutes = cljs.core.nth.call(null,vec__11000,4,null);var seconds = cljs.core.nth.call(null,vec__11000,5,null);var ms = cljs.core.nth.call(null,vec__11000,6,null);var offset = cljs.core.nth.call(null,vec__11000,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
