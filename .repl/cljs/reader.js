...
{var x__4992__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.read_char[goog.typeOf(x__4992__auto__)]);if(or__3943__auto__)
...
{var x__4992__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.unread[goog.typeOf(x__4992__auto__)]);if(or__3943__auto__)
{return or__3943__auto__;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__4933__auto__,writer__4934__auto__,opt__4935__auto__){return cljs.core._write.call(null,writer__4934__auto__,"cljs.reader/StringPushbackReader");
});
...
reader_error.cljs$lang$applyTo = (function (arglist__11078){
var rdr = cljs.core.first(arglist__11078);
var msg = cljs.core.rest(arglist__11078);
...
{{
var G__11079 = (function (){sb.append(ch);
return sb;
})();
var G__11080 = cljs.reader.read_char.call(null,rdr);
sb = G__11079;
ch = G__11080;
continue;
}
...
{{
var G__11081 = cljs.reader.read_char.call(null,rdr);
ch = G__11081;
continue;
}
} else
...
var G__11082 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__11082;
continue;
}
} else
...
var G__11083 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__11083;
continue;
}
}
...
{{
var G__11084 = (function (){buffer.append(ch);
return buffer;
})();
var G__11085 = cljs.reader.read_char.call(null,reader);
buffer = G__11084;
ch = G__11085;
continue;
}
...
{if(("\\" === ch))
{{
var G__11086 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__11087 = cljs.reader.read_char.call(null,reader);
buffer = G__11086;
ch = G__11087;
continue;
}
...
{{
var G__11088 = (function (){buffer.append(ch);
return buffer;
})();
var G__11089 = cljs.reader.read_char.call(null,reader);
buffer = G__11088;
ch = G__11089;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__11091 = o;if(G__11091)
{if((function (){var or__3943__auto__ = (G__11091.cljs$lang$protocol_mask$partition0$ & 262144);if(or__3943__auto__)
{return or__3943__auto__;
} else
{return G__11091.cljs$core$IWithMeta$;
}
})())
{return true;
} else
{if((!G__11091.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__11091);
} else
{return false;
}
}
...
{{
var G__11092 = reader;
var G__11093 = eof_is_error;
var G__11094 = sentinel;
var G__11095 = is_recursive;
reader = G__11092;
eof_is_error = G__11093;
sentinel = G__11094;
is_recursive = G__11095;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__11096 = cljs.reader.read_comment.call(null,reader,ch);
var G__11097 = eof_is_error;
var G__11098 = sentinel;
var G__11099 = is_recursive;
reader = G__11096;
eof_is_error = G__11097;
sentinel = G__11098;
is_recursive = G__11099;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__11100 = reader;
var G__11101 = eof_is_error;
var G__11102 = sentinel;
var G__11103 = is_recursive;
reader = G__11100;
eof_is_error = G__11101;
sentinel = G__11102;
is_recursive = G__11103;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__11106 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__11106,0,null);var years = cljs.core.nth.call(null,vec__11106,1,null);var months = cljs.core.nth.call(null,vec__11106,2,null);var days = cljs.core.nth.call(null,vec__11106,3,null);var hours = cljs.core.nth.call(null,vec__11106,4,null);var minutes = cljs.core.nth.call(null,vec__11106,5,null);var seconds = cljs.core.nth.call(null,vec__11106,6,null);var fraction = cljs.core.nth.call(null,vec__11106,7,null);var offset_sign = cljs.core.nth.call(null,vec__11106,8,null);var offset_hours = cljs.core.nth.call(null,vec__11106,9,null);var offset_minutes = cljs.core.nth.call(null,vec__11106,10,null);var v = vec__11106;if(cljs.core.not.call(null,v))
...
{var vec__11108 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__11108,0,null);var months = cljs.core.nth.call(null,vec__11108,1,null);var days = cljs.core.nth.call(null,vec__11108,2,null);var hours = cljs.core.nth.call(null,vec__11108,3,null);var minutes = cljs.core.nth.call(null,vec__11108,4,null);var seconds = cljs.core.nth.call(null,vec__11108,5,null);var ms = cljs.core.nth.call(null,vec__11108,6,null);var offset = cljs.core.nth.call(null,vec__11108,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
