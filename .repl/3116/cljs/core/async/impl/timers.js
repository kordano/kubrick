...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6738__auto__,writer__6739__auto__,opt__6740__auto__){return cljs.core._write.call(null,writer__6739__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13344 = 0;while(true){
if((i_13344 < arr.length))
{(arr[i_13344] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6738__auto__,writer__6739__auto__,opt__6740__auto__){return cljs.core._write.call(null,writer__6739__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13351 = (self__.level + 1);while(true){
if((i_13351 <= (new_level + 1)))
{(update[i_13351] = self__.header);
{
var G__13352 = (i_13351 + 1);
i_13351 = G__13352;
continue;
}
} else
...
{var i_13353 = 0;while(true){
if((i_13353 <= self__.level))
{var links_13354 = (update[i_13353]).forward;if(((links_13354[i_13353]) === x__$1))
{(links_13354[i_13353] = (x__$1.forward[i_13353]));
{
