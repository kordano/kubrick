...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13373 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t13373');

/**
* @constructor
*/
cljs.core.async.impl.channels.t13373 = (function (val,box,meta13374){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13373.cljs$lang$type = true;
cljs.core.async.impl.channels.t13373.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13373";
cljs.core.async.impl.channels.t13373.cljs$lang$ctorPrWriter = (function (this__6738__auto__,writer__6739__auto__,opt__6740__auto__){return cljs.core._write.call(null,writer__6739__auto__,"cljs.core.async.impl.channels/t13373");
});
cljs.core.async.impl.channels.t13373.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t13373.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13375){var self__ = this;
return self__.meta13374;
});
cljs.core.async.impl.channels.t13373.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13375,meta13374__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t13373(self__.val,self__.box,meta13374__$1));
});
cljs.core.async.impl.channels.__GT_t13373 = (function __GT_t13373(val__$1,box__$1,meta13374){return (new cljs.core.async.impl.channels.t13373(val__$1,box__$1,meta13374));
});
}
return (new cljs.core.async.impl.channels.t13373(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6741__auto__,writer__6742__auto__,opts__6743__auto__){return cljs.core._write.call(null,writer__6742__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6738__auto__,writer__6739__auto__,opt__6740__auto__){return cljs.core._write.call(null,writer__6739__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13376 = self__.takes.pop();if((taker_13376 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13376))
{var take_cb_13377 = cljs.core.async.impl.protocols.commit.call(null,taker_13376);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13377,taker_13376){
return (function (){return take_cb_13377.call(null,null);
});})(take_cb_13377,taker_13376))
);
} else
{}
{
