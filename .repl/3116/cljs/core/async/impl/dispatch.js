...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13367 = 0;while(true){
var m_13368 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13368 == null))
{} else
{m_13368.call(null);
if((count_13367 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13369 = (count_13367 + 1);
count_13367 = G__13369;
continue;
}
} else
{}
