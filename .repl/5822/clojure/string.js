...
{{
var G__14736 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14736;
continue;
}
} else
...
{var pred__14740 = cljs.core._EQ_;var expr__14741 = limit;if(pred__14740.call(null,1,expr__14741))
{return cljs.core.vector.call(null,s);
} else
{if(pred__14740.call(null,2,expr__14741))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__14743 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14744 = (limit__$1 - 1);
var G__14745 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14743;
limit__$1 = G__14744;
parts = G__14745;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14747 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14747))
{var replacement_14748 = temp__4090__auto___14747;buffer.append([cljs.core.str(replacement_14748)].join(''));
} else
{buffer.append(ch);
}
{
var G__14749 = (index + 1);
index = G__14749;
continue;
}
}
