...
hiccups.runtime.in_mode = (function in_mode(mode,f){var _STAR_html_mode_STAR_15188 = hiccups.runtime._STAR_html_mode_STAR_;try{hiccups.runtime._STAR_html_mode_STAR_ = mode;
return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_15188;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__15189){var vec__15191 = p__15189;var name = cljs.core.nth.call(null,vec__15191,0,null);var value = cljs.core.nth.call(null,vec__15191,1,null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__15192){var vec__15195 = p__15192;var tag = cljs.core.nth.call(null,vec__15195,0,null);var content = cljs.core.nthnext.call(null,vec__15195,1);if(!((function (){var or__3943__auto__ = (tag instanceof cljs.core.Keyword);if(or__3943__auto__)
{return or__3943__auto__;
} else
...
{}
var vec__15196 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));var _ = cljs.core.nth.call(null,vec__15196,0,null);var tag__$1 = cljs.core.nth.call(null,vec__15196,1,null);var id = cljs.core.nth.call(null,vec__15196,2,null);var class$ = cljs.core.nth.call(null,vec__15196,3,null);var tag_attrs = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),(cljs.core.truth_(class$)?class$.replace("."," "):null)], true);var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__15198 = hiccups.runtime.normalize_element.call(null,element);var tag = cljs.core.nth.call(null,vec__15198,0,null);var attrs = cljs.core.nth.call(null,vec__15198,1,null);var content = cljs.core.nth.call(null,vec__15198,2,null);if(cljs.core.truth_((function (){var or__3943__auto__ = content;if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
