...
{var x__7093__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.read_char[goog.typeOf(x__7093__auto__)]);if(or__3943__auto__)
...
{var x__7093__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.unread[goog.typeOf(x__7093__auto__)]);if(or__3943__auto__)
{return or__3943__auto__;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__7018__auto__,writer__7019__auto__,opt__7020__auto__){return cljs.core._write.call(null,writer__7019__auto__,"cljs.reader/StringPushbackReader");
});
...
reader_error.cljs$lang$applyTo = (function (arglist__12304){
var rdr = cljs.core.first(arglist__12304);
var msg = cljs.core.rest(arglist__12304);
...
{{
var G__12305 = (function (){sb.append(ch);
return sb;
})();
var G__12306 = cljs.reader.read_char.call(null,rdr);
sb = G__12305;
ch = G__12306;
continue;
}
...
{{
var G__12307 = cljs.reader.read_char.call(null,rdr);
ch = G__12307;
continue;
}
} else
...
var G__12308 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__12308;
continue;
}
} else
...
var G__12309 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__12309;
continue;
}
}
...
{{
var G__12310 = (function (){buffer.append(ch);
return buffer;
})();
var G__12311 = cljs.reader.read_char.call(null,reader);
buffer = G__12310;
ch = G__12311;
continue;
}
...
{if(("\\" === ch))
{{
var G__12312 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
...
{{
var G__12314 = (function (){buffer.append(ch);
return buffer;
})();
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__12317 = o;if(G__12317)
{if((function (){var or__3943__auto__ = (G__12317.cljs$lang$protocol_mask$partition0$ & 262144);if(or__3943__auto__)
{return or__3943__auto__;
} else
{return G__12317.cljs$core$IWithMeta$;
}
})())
{return true;
} else
{if((!G__12317.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__12317);
} else
{return false;
}
}
...
{{
var G__12318 = reader;
var G__12319 = eof_is_error;
var G__12320 = sentinel;
var G__12321 = is_recursive;
reader = G__12318;
eof_is_error = G__12319;
sentinel = G__12320;
is_recursive = G__12321;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__12322 = cljs.reader.read_comment.call(null,reader,ch);
var G__12323 = eof_is_error;
var G__12324 = sentinel;
var G__12325 = is_recursive;
reader = G__12322;
eof_is_error = G__12323;
sentinel = G__12324;
is_recursive = G__12325;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__12326 = reader;
var G__12327 = eof_is_error;
var G__12328 = sentinel;
var G__12329 = is_recursive;
reader = G__12326;
eof_is_error = G__12327;
sentinel = G__12328;
is_recursive = G__12329;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__12332 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__12332,0,null);var years = cljs.core.nth.call(null,vec__12332,1,null);var months = cljs.core.nth.call(null,vec__12332,2,null);var days = cljs.core.nth.call(null,vec__12332,3,null);var hours = cljs.core.nth.call(null,vec__12332,4,null);var minutes = cljs.core.nth.call(null,vec__12332,5,null);var seconds = cljs.core.nth.call(null,vec__12332,6,null);var fraction = cljs.core.nth.call(null,vec__12332,7,null);var offset_sign = cljs.core.nth.call(null,vec__12332,8,null);var offset_hours = cljs.core.nth.call(null,vec__12332,9,null);var offset_minutes = cljs.core.nth.call(null,vec__12332,10,null);var v = vec__12332;if(cljs.core.not.call(null,v))
...
{var vec__12334 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__12334,0,null);var months = cljs.core.nth.call(null,vec__12334,1,null);var days = cljs.core.nth.call(null,vec__12334,2,null);var hours = cljs.core.nth.call(null,vec__12334,3,null);var minutes = cljs.core.nth.call(null,vec__12334,4,null);var seconds = cljs.core.nth.call(null,vec__12334,5,null);var ms = cljs.core.nth.call(null,vec__12334,6,null);var offset = cljs.core.nth.call(null,vec__12334,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
