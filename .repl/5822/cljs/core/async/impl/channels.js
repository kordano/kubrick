...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14308 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t14308');

/**
* @constructor
*/
cljs.core.async.impl.channels.t14308 = (function (val,box,meta14309){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14308.cljs$lang$type = true;
cljs.core.async.impl.channels.t14308.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14308";
cljs.core.async.impl.channels.t14308.cljs$lang$ctorPrWriter = (function (this__7018__auto__,writer__7019__auto__,opt__7020__auto__){return cljs.core._write.call(null,writer__7019__auto__,"cljs.core.async.impl.channels/t14308");
});
cljs.core.async.impl.channels.t14308.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t14308.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14310){var self__ = this;
return self__.meta14309;
});
cljs.core.async.impl.channels.t14308.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14310,meta14309__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t14308(self__.val,self__.box,meta14309__$1));
});
cljs.core.async.impl.channels.__GT_t14308 = (function __GT_t14308(val__$1,box__$1,meta14309){return (new cljs.core.async.impl.channels.t14308(val__$1,box__$1,meta14309));
});
}
return (new cljs.core.async.impl.channels.t14308(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__7021__auto__,writer__7022__auto__,opts__7023__auto__){return cljs.core._write.call(null,writer__7022__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__7018__auto__,writer__7019__auto__,opt__7020__auto__){return cljs.core._write.call(null,writer__7019__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14311 = self__.takes.pop();if((taker_14311 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14311))
{var take_cb_14312 = cljs.core.async.impl.protocols.commit.call(null,taker_14311);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14312,taker_14311){
return (function (){return take_cb_14312.call(null,null);
});})(take_cb_14312,taker_14311))
);
} else
{}
{
