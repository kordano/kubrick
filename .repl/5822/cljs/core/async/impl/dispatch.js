...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14302 = 0;while(true){
var m_14303 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14303 == null))
{} else
{m_14303.call(null);
if((count_14302 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14304 = (count_14302 + 1);
count_14302 = G__14304;
continue;
}
} else
{}
