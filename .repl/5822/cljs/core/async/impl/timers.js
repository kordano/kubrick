...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__7018__auto__,writer__7019__auto__,opt__7020__auto__){return cljs.core._write.call(null,writer__7019__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14279 = 0;while(true){
if((i_14279 < arr.length))
{(arr[i_14279] = null);
{
var G__14280 = (i_14279 + 1);
i_14279 = G__14280;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__7018__auto__,writer__7019__auto__,opt__7020__auto__){return cljs.core._write.call(null,writer__7019__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14286 = (self__.level + 1);while(true){
if((i_14286 <= (new_level + 1)))
{(update[i_14286] = self__.header);
{
...
{var i_14288 = 0;while(true){
if((i_14288 <= self__.level))
{var links_14289 = (update[i_14288]).forward;if(((links_14289[i_14288]) === x__$1))
{(links_14289[i_14288] = (x__$1.forward[i_14288]));
{
var G__14290 = (i_14288 + 1);
i_14288 = G__14290;
continue;
}
} else
