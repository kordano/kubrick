...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6725__auto__,writer__6726__auto__,opt__6727__auto__){return cljs.core._write.call(null,writer__6726__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13635 = 0;while(true){
if((i_13635 < arr.length))
{(arr[i_13635] = null);
{
var G__13636 = (i_13635 + 1);
i_13635 = G__13636;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6725__auto__,writer__6726__auto__,opt__6727__auto__){return cljs.core._write.call(null,writer__6726__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13642 = (self__.level + 1);while(true){
if((i_13642 <= (new_level + 1)))
{(update[i_13642] = self__.header);
{
var G__13643 = (i_13642 + 1);
i_13642 = G__13643;
continue;
}
} else
...
{var i_13644 = 0;while(true){
if((i_13644 <= self__.level))
{var links_13645 = (update[i_13644]).forward;if(((links_13645[i_13644]) === x__$1))
{(links_13645[i_13644] = (x__$1.forward[i_13644]));
{
var G__13646 = (i_13644 + 1);
i_13644 = G__13646;
continue;
}
} else
{{
var G__13647 = (i_13644 + 1);
i_13644 = G__13647;
continue;
}
}
