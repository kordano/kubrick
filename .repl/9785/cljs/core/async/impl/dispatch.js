...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13658 = 0;while(true){
var m_13659 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13659 == null))
{} else
{m_13659.call(null);
if((count_13658 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13660 = (count_13658 + 1);
count_13658 = G__13660;
continue;
}
} else
{}
