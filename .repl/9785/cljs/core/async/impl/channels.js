...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13664 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t13664');

/**
* @constructor
*/
cljs.core.async.impl.channels.t13664 = (function (val,box,meta13665){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13664.cljs$lang$type = true;
cljs.core.async.impl.channels.t13664.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13664";
cljs.core.async.impl.channels.t13664.cljs$lang$ctorPrWriter = (function (this__6725__auto__,writer__6726__auto__,opt__6727__auto__){return cljs.core._write.call(null,writer__6726__auto__,"cljs.core.async.impl.channels/t13664");
});
cljs.core.async.impl.channels.t13664.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t13664.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13666){var self__ = this;
return self__.meta13665;
});
cljs.core.async.impl.channels.t13664.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13666,meta13665__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t13664(self__.val,self__.box,meta13665__$1));
});
cljs.core.async.impl.channels.__GT_t13664 = (function __GT_t13664(val__$1,box__$1,meta13665){return (new cljs.core.async.impl.channels.t13664(val__$1,box__$1,meta13665));
});
}
return (new cljs.core.async.impl.channels.t13664(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6728__auto__,writer__6729__auto__,opts__6730__auto__){return cljs.core._write.call(null,writer__6729__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6725__auto__,writer__6726__auto__,opt__6727__auto__){return cljs.core._write.call(null,writer__6726__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13667 = self__.takes.pop();if((taker_13667 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13667))
{var take_cb_13668 = cljs.core.async.impl.protocols.commit.call(null,taker_13667);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13668,taker_13667){
return (function (){return take_cb_13668.call(null,null);
});})(take_cb_13668,taker_13667))
);
} else
{}
{
