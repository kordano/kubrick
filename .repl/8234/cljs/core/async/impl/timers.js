...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6747__auto__,writer__6748__auto__,opt__6749__auto__){return cljs.core._write.call(null,writer__6748__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13359 = 0;while(true){
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6747__auto__,writer__6748__auto__,opt__6749__auto__){return cljs.core._write.call(null,writer__6748__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13366 = (self__.level + 1);while(true){
if((i_13366 <= (new_level + 1)))
{(update[i_13366] = self__.header);
{
var G__13367 = (i_13366 + 1);
i_13366 = G__13367;
continue;
}
} else
...
{var i_13368 = 0;while(true){
if((i_13368 <= self__.level))
{var links_13369 = (update[i_13368]).forward;if(((links_13369[i_13368]) === x__$1))
{(links_13369[i_13368] = (x__$1.forward[i_13368]));
{
var G__13370 = (i_13368 + 1);
i_13368 = G__13370;
continue;
}
} else
{{
var G__13371 = (i_13368 + 1);
i_13368 = G__13371;
continue;
}
}
