...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13382 = 0;while(true){
var m_13383 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13383 == null))
{} else
{m_13383.call(null);
if((count_13382 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13384 = (count_13382 + 1);
count_13382 = G__13384;
continue;
}
} else
{}
