...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13388 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t13388');

/**
* @constructor
*/
cljs.core.async.impl.channels.t13388 = (function (val,box,meta13389){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13388.cljs$lang$type = true;
cljs.core.async.impl.channels.t13388.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13388";
cljs.core.async.impl.channels.t13388.cljs$lang$ctorPrWriter = (function (this__6747__auto__,writer__6748__auto__,opt__6749__auto__){return cljs.core._write.call(null,writer__6748__auto__,"cljs.core.async.impl.channels/t13388");
});
cljs.core.async.impl.channels.t13388.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t13388.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13390){var self__ = this;
return self__.meta13389;
});
cljs.core.async.impl.channels.t13388.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13390,meta13389__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t13388(self__.val,self__.box,meta13389__$1));
});
cljs.core.async.impl.channels.__GT_t13388 = (function __GT_t13388(val__$1,box__$1,meta13389){return (new cljs.core.async.impl.channels.t13388(val__$1,box__$1,meta13389));
});
}
return (new cljs.core.async.impl.channels.t13388(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6750__auto__,writer__6751__auto__,opts__6752__auto__){return cljs.core._write.call(null,writer__6751__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6747__auto__,writer__6748__auto__,opt__6749__auto__){return cljs.core._write.call(null,writer__6748__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13391 = self__.takes.pop();if((taker_13391 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13391))
{var take_cb_13392 = cljs.core.async.impl.protocols.commit.call(null,taker_13391);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13392,taker_13391){
return (function (){return take_cb_13392.call(null,null);
});})(take_cb_13392,taker_13391))
);
} else
{}
{
