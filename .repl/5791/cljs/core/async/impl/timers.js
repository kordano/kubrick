...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__7014__auto__,writer__7015__auto__,opt__7016__auto__){return cljs.core._write.call(null,writer__7015__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14283 = 0;while(true){
if((i_14283 < arr.length))
{(arr[i_14283] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__7014__auto__,writer__7015__auto__,opt__7016__auto__){return cljs.core._write.call(null,writer__7015__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14290 = (self__.level + 1);while(true){
...
{var i_14292 = 0;while(true){
if((i_14292 <= self__.level))
{var links_14293 = (update[i_14292]).forward;if(((links_14293[i_14292]) === x__$1))
{(links_14293[i_14292] = (x__$1.forward[i_14292]));
{
var G__14294 = (i_14292 + 1);
i_14292 = G__14294;
continue;
}
} else
{{
var G__14295 = (i_14292 + 1);
i_14292 = G__14295;
continue;
}
}
