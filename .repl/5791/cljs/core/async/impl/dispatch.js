...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14306 = 0;while(true){
var m_14307 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14307 == null))
{} else
{m_14307.call(null);
if((count_14306 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14308 = (count_14306 + 1);
count_14306 = G__14308;
continue;
}
} else
{}
