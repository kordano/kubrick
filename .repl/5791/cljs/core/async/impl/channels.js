...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14312 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t14312');

/**
* @constructor
*/
cljs.core.async.impl.channels.t14312 = (function (val,box,meta14313){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14312.cljs$lang$type = true;
cljs.core.async.impl.channels.t14312.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14312";
cljs.core.async.impl.channels.t14312.cljs$lang$ctorPrWriter = (function (this__7014__auto__,writer__7015__auto__,opt__7016__auto__){return cljs.core._write.call(null,writer__7015__auto__,"cljs.core.async.impl.channels/t14312");
});
cljs.core.async.impl.channels.t14312.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t14312.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14314){var self__ = this;
return self__.meta14313;
});
cljs.core.async.impl.channels.t14312.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14314,meta14313__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t14312(self__.val,self__.box,meta14313__$1));
});
cljs.core.async.impl.channels.__GT_t14312 = (function __GT_t14312(val__$1,box__$1,meta14313){return (new cljs.core.async.impl.channels.t14312(val__$1,box__$1,meta14313));
});
}
return (new cljs.core.async.impl.channels.t14312(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__7017__auto__,writer__7018__auto__,opts__7019__auto__){return cljs.core._write.call(null,writer__7018__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__7014__auto__,writer__7015__auto__,opt__7016__auto__){return cljs.core._write.call(null,writer__7015__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14315 = self__.takes.pop();if((taker_14315 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14315))
{var take_cb_14316 = cljs.core.async.impl.protocols.commit.call(null,taker_14315);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14316,taker_14315){
return (function (){return take_cb_14316.call(null,null);
});})(take_cb_14316,taker_14315))
);
} else
{}
{
