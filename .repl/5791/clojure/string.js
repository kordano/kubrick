...
{{
var G__14740 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14740;
continue;
}
} else
...
{var pred__14744 = cljs.core._EQ_;var expr__14745 = limit;if(pred__14744.call(null,1,expr__14745))
{return cljs.core.vector.call(null,s);
} else
{if(pred__14744.call(null,2,expr__14745))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__14747 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14748 = (limit__$1 - 1);
var G__14749 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14747;
limit__$1 = G__14748;
parts = G__14749;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14751 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14751))
{var replacement_14752 = temp__4090__auto___14751;buffer.append([cljs.core.str(replacement_14752)].join(''));
} else
{buffer.append(ch);
}
{
var G__14753 = (index + 1);
index = G__14753;
continue;
}
}
