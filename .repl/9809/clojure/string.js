...
{{
var G__14481 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14481;
continue;
}
} else
...
{var pred__14485 = cljs.core._EQ_;var expr__14486 = limit;if(pred__14485.call(null,1,expr__14486))
{return cljs.core.vector.call(null,s);
} else
{if(pred__14485.call(null,2,expr__14486))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__14488 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14489 = (limit__$1 - 1);
var G__14490 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14488;
limit__$1 = G__14489;
parts = G__14490;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14492 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14492))
{var replacement_14493 = temp__4090__auto___14492;buffer.append([cljs.core.str(replacement_14493)].join(''));
} else
{buffer.append(ch);
}
{
var G__14494 = (index + 1);
index = G__14494;
continue;
}
}
