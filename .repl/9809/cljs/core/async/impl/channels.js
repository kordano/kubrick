...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14053 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t14053');

/**
* @constructor
*/
cljs.core.async.impl.channels.t14053 = (function (val,box,meta14054){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14053.cljs$lang$type = true;
cljs.core.async.impl.channels.t14053.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14053";
cljs.core.async.impl.channels.t14053.cljs$lang$ctorPrWriter = (function (this__6772__auto__,writer__6773__auto__,opt__6774__auto__){return cljs.core._write.call(null,writer__6773__auto__,"cljs.core.async.impl.channels/t14053");
});
cljs.core.async.impl.channels.t14053.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t14053.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14055){var self__ = this;
return self__.meta14054;
});
cljs.core.async.impl.channels.t14053.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14055,meta14054__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t14053(self__.val,self__.box,meta14054__$1));
});
cljs.core.async.impl.channels.__GT_t14053 = (function __GT_t14053(val__$1,box__$1,meta14054){return (new cljs.core.async.impl.channels.t14053(val__$1,box__$1,meta14054));
});
}
return (new cljs.core.async.impl.channels.t14053(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6775__auto__,writer__6776__auto__,opts__6777__auto__){return cljs.core._write.call(null,writer__6776__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6772__auto__,writer__6773__auto__,opt__6774__auto__){return cljs.core._write.call(null,writer__6773__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14056 = self__.takes.pop();if((taker_14056 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14056))
{var take_cb_14057 = cljs.core.async.impl.protocols.commit.call(null,taker_14056);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14057,taker_14056){
return (function (){return take_cb_14057.call(null,null);
});})(take_cb_14057,taker_14056))
);
} else
{}
{
