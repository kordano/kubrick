...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14047 = 0;while(true){
var m_14048 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14048 == null))
{} else
{m_14048.call(null);
if((count_14047 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14049 = (count_14047 + 1);
count_14047 = G__14049;
continue;
}
} else
{}
