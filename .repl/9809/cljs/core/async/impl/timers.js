...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6772__auto__,writer__6773__auto__,opt__6774__auto__){return cljs.core._write.call(null,writer__6773__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14024 = 0;while(true){
if((i_14024 < arr.length))
{(arr[i_14024] = null);
{
var G__14025 = (i_14024 + 1);
i_14024 = G__14025;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6772__auto__,writer__6773__auto__,opt__6774__auto__){return cljs.core._write.call(null,writer__6773__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14031 = (self__.level + 1);while(true){
if((i_14031 <= (new_level + 1)))
{(update[i_14031] = self__.header);
{
var G__14032 = (i_14031 + 1);
i_14031 = G__14032;
continue;
}
} else
...
{var i_14033 = 0;while(true){
if((i_14033 <= self__.level))
{var links_14034 = (update[i_14033]).forward;if(((links_14034[i_14033]) === x__$1))
{(links_14034[i_14033] = (x__$1.forward[i_14033]));
{
