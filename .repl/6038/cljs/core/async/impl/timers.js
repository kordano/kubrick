...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6812__auto__,writer__6813__auto__,opt__6814__auto__){return cljs.core._write.call(null,writer__6813__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13503 = 0;while(true){
if((i_13503 < arr.length))
{(arr[i_13503] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6812__auto__,writer__6813__auto__,opt__6814__auto__){return cljs.core._write.call(null,writer__6813__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13510 = (self__.level + 1);while(true){
if((i_13510 <= (new_level + 1)))
{(update[i_13510] = self__.header);
{
...
{var i_13512 = 0;while(true){
if((i_13512 <= self__.level))
{var links_13513 = (update[i_13512]).forward;if(((links_13513[i_13512]) === x__$1))
{(links_13513[i_13512] = (x__$1.forward[i_13512]));
{
var G__13514 = (i_13512 + 1);
i_13512 = G__13514;
continue;
}
} else
{{
var G__13515 = (i_13512 + 1);
i_13512 = G__13515;
continue;
}
}
