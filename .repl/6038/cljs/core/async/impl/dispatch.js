...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13526 = 0;while(true){
var m_13527 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13527 == null))
{} else
{m_13527.call(null);
if((count_13526 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13528 = (count_13526 + 1);
count_13526 = G__13528;
continue;
}
} else
{}
