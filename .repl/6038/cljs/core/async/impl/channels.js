...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13532 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t13532');

/**
* @constructor
*/
cljs.core.async.impl.channels.t13532 = (function (val,box,meta13533){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13532.cljs$lang$type = true;
cljs.core.async.impl.channels.t13532.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13532";
cljs.core.async.impl.channels.t13532.cljs$lang$ctorPrWriter = (function (this__6812__auto__,writer__6813__auto__,opt__6814__auto__){return cljs.core._write.call(null,writer__6813__auto__,"cljs.core.async.impl.channels/t13532");
});
cljs.core.async.impl.channels.t13532.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t13532.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13534){var self__ = this;
return self__.meta13533;
});
cljs.core.async.impl.channels.t13532.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13534,meta13533__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t13532(self__.val,self__.box,meta13533__$1));
});
cljs.core.async.impl.channels.__GT_t13532 = (function __GT_t13532(val__$1,box__$1,meta13533){return (new cljs.core.async.impl.channels.t13532(val__$1,box__$1,meta13533));
});
}
return (new cljs.core.async.impl.channels.t13532(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6815__auto__,writer__6816__auto__,opts__6817__auto__){return cljs.core._write.call(null,writer__6816__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6812__auto__,writer__6813__auto__,opt__6814__auto__){return cljs.core._write.call(null,writer__6813__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_13535 = self__.takes.pop();if((taker_13535 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13535))
{var take_cb_13536 = cljs.core.async.impl.protocols.commit.call(null,taker_13535);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13536,taker_13535){
return (function (){return take_cb_13536.call(null,null);
});})(take_cb_13536,taker_13535))
);
} else
{}
{
