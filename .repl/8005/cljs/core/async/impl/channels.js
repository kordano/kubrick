...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13372 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t13372');

/**
* @constructor
*/
cljs.core.async.impl.channels.t13372 = (function (val,box,meta13373){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13372.cljs$lang$type = true;
cljs.core.async.impl.channels.t13372.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13372";
cljs.core.async.impl.channels.t13372.cljs$lang$ctorPrWriter = (function (this__6747__auto__,writer__6748__auto__,opt__6749__auto__){return cljs.core._write.call(null,writer__6748__auto__,"cljs.core.async.impl.channels/t13372");
});
cljs.core.async.impl.channels.t13372.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t13372.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13374){var self__ = this;
return self__.meta13373;
});
cljs.core.async.impl.channels.t13372.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13374,meta13373__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t13372(self__.val,self__.box,meta13373__$1));
});
cljs.core.async.impl.channels.__GT_t13372 = (function __GT_t13372(val__$1,box__$1,meta13373){return (new cljs.core.async.impl.channels.t13372(val__$1,box__$1,meta13373));
});
}
return (new cljs.core.async.impl.channels.t13372(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13375 = self__.takes.pop();if((taker_13375 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13375))
{var take_cb_13376 = cljs.core.async.impl.protocols.commit.call(null,taker_13375);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13376,taker_13375){
return (function (){return take_cb_13376.call(null,null);
});})(take_cb_13376,taker_13375))
);
} else
{}
{
