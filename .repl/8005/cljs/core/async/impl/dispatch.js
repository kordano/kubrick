...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13366 = 0;while(true){
var m_13367 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13367 == null))
{} else
{m_13367.call(null);
if((count_13366 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13368 = (count_13366 + 1);
count_13366 = G__13368;
continue;
}
} else
{}
