...
{var x__6814__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.read_char[goog.typeOf(x__6814__auto__)]);if(or__3943__auto__)
...
{var x__6814__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.unread[goog.typeOf(x__6814__auto__)]);if(or__3943__auto__)
{return or__3943__auto__;
} else
...
reader_error.cljs$lang$applyTo = (function (arglist__11368){
var rdr = cljs.core.first(arglist__11368);
var msg = cljs.core.rest(arglist__11368);
...
{{
var G__11369 = (function (){sb.append(ch);
return sb;
})();
var G__11370 = cljs.reader.read_char.call(null,rdr);
sb = G__11369;
ch = G__11370;
continue;
}
...
var G__11372 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__11372;
continue;
}
} else
...
var G__11373 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__11373;
continue;
}
}
...
{{
var G__11374 = (function (){buffer.append(ch);
return buffer;
})();
var G__11375 = cljs.reader.read_char.call(null,reader);
buffer = G__11374;
ch = G__11375;
continue;
}
...
{if(("\\" === ch))
{{
var G__11376 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__11377 = cljs.reader.read_char.call(null,reader);
buffer = G__11376;
ch = G__11377;
continue;
}
...
{{
var G__11378 = (function (){buffer.append(ch);
return buffer;
})();
var G__11379 = cljs.reader.read_char.call(null,reader);
buffer = G__11378;
ch = G__11379;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__11381 = o;if(G__11381)
{if((function (){var or__3943__auto__ = (G__11381.cljs$lang$protocol_mask$partition0$ & 262144);if(or__3943__auto__)
{return or__3943__auto__;
} else
{return G__11381.cljs$core$IWithMeta$;
}
})())
{return true;
} else
{if((!G__11381.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__11381);
} else
{return false;
}
}
...
{{
var G__11386 = cljs.reader.read_comment.call(null,reader,ch);
var G__11387 = eof_is_error;
var G__11388 = sentinel;
var G__11389 = is_recursive;
reader = G__11386;
eof_is_error = G__11387;
sentinel = G__11388;
is_recursive = G__11389;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__11390 = reader;
var G__11391 = eof_is_error;
var G__11392 = sentinel;
var G__11393 = is_recursive;
reader = G__11390;
eof_is_error = G__11391;
sentinel = G__11392;
is_recursive = G__11393;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__11396 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__11396,0,null);var years = cljs.core.nth.call(null,vec__11396,1,null);var months = cljs.core.nth.call(null,vec__11396,2,null);var days = cljs.core.nth.call(null,vec__11396,3,null);var hours = cljs.core.nth.call(null,vec__11396,4,null);var minutes = cljs.core.nth.call(null,vec__11396,5,null);var seconds = cljs.core.nth.call(null,vec__11396,6,null);var fraction = cljs.core.nth.call(null,vec__11396,7,null);var offset_sign = cljs.core.nth.call(null,vec__11396,8,null);var offset_hours = cljs.core.nth.call(null,vec__11396,9,null);var offset_minutes = cljs.core.nth.call(null,vec__11396,10,null);var v = vec__11396;if(cljs.core.not.call(null,v))
...
{var vec__11398 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__11398,0,null);var months = cljs.core.nth.call(null,vec__11398,1,null);var days = cljs.core.nth.call(null,vec__11398,2,null);var hours = cljs.core.nth.call(null,vec__11398,3,null);var minutes = cljs.core.nth.call(null,vec__11398,4,null);var seconds = cljs.core.nth.call(null,vec__11398,5,null);var ms = cljs.core.nth.call(null,vec__11398,6,null);var offset = cljs.core.nth.call(null,vec__11398,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
