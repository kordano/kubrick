...
{{
var G__14437 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14437;
continue;
}
} else
...
{var pred__14441 = cljs.core._EQ_;var expr__14442 = limit;if(pred__14441.call(null,1,expr__14442))
{return cljs.core.vector.call(null,s);
} else
{if(pred__14441.call(null,2,expr__14442))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__14444 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14445 = (limit__$1 - 1);
var G__14446 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14444;
limit__$1 = G__14445;
parts = G__14446;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14448 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14448))
{var replacement_14449 = temp__4090__auto___14448;buffer.append([cljs.core.str(replacement_14449)].join(''));
} else
{buffer.append(ch);
}
{
var G__14450 = (index + 1);
index = G__14450;
continue;
}
}
