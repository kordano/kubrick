...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6736__auto__,writer__6737__auto__,opt__6738__auto__){return cljs.core._write.call(null,writer__6737__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13980 = 0;while(true){
if((i_13980 < arr.length))
{(arr[i_13980] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6736__auto__,writer__6737__auto__,opt__6738__auto__){return cljs.core._write.call(null,writer__6737__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13987 = (self__.level + 1);while(true){
if((i_13987 <= (new_level + 1)))
{(update[i_13987] = self__.header);
{
var G__13988 = (i_13987 + 1);
i_13987 = G__13988;
continue;
}
} else
...
{var i_13989 = 0;while(true){
if((i_13989 <= self__.level))
{var links_13990 = (update[i_13989]).forward;if(((links_13990[i_13989]) === x__$1))
{(links_13990[i_13989] = (x__$1.forward[i_13989]));
{
var G__13991 = (i_13989 + 1);
i_13989 = G__13991;
continue;
}
} else
{{
var G__13992 = (i_13989 + 1);
i_13989 = G__13992;
continue;
}
}
