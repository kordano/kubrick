...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14003 = 0;while(true){
var m_14004 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14004 == null))
{} else
{m_14004.call(null);
if((count_14003 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14005 = (count_14003 + 1);
count_14003 = G__14005;
continue;
}
} else
{}
