...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14009 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t14009');

/**
* @constructor
*/
cljs.core.async.impl.channels.t14009 = (function (val,box,meta14010){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14009.cljs$lang$type = true;
cljs.core.async.impl.channels.t14009.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14009";
cljs.core.async.impl.channels.t14009.cljs$lang$ctorPrWriter = (function (this__6736__auto__,writer__6737__auto__,opt__6738__auto__){return cljs.core._write.call(null,writer__6737__auto__,"cljs.core.async.impl.channels/t14009");
});
cljs.core.async.impl.channels.t14009.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t14009.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14011){var self__ = this;
return self__.meta14010;
});
cljs.core.async.impl.channels.t14009.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14011,meta14010__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t14009(self__.val,self__.box,meta14010__$1));
});
cljs.core.async.impl.channels.__GT_t14009 = (function __GT_t14009(val__$1,box__$1,meta14010){return (new cljs.core.async.impl.channels.t14009(val__$1,box__$1,meta14010));
});
}
return (new cljs.core.async.impl.channels.t14009(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6739__auto__,writer__6740__auto__,opts__6741__auto__){return cljs.core._write.call(null,writer__6740__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6736__auto__,writer__6737__auto__,opt__6738__auto__){return cljs.core._write.call(null,writer__6737__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14012 = self__.takes.pop();if((taker_14012 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14012))
{var take_cb_14013 = cljs.core.async.impl.protocols.commit.call(null,taker_14012);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14013,taker_14012){
return (function (){return take_cb_14013.call(null,null);
});})(take_cb_14013,taker_14012))
);
} else
{}
{
