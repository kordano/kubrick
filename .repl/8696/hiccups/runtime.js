...
hiccups.runtime.in_mode = (function in_mode(mode,f){var _STAR_html_mode_STAR_14912 = hiccups.runtime._STAR_html_mode_STAR_;try{hiccups.runtime._STAR_html_mode_STAR_ = mode;
return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_14912;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__14913){var vec__14915 = p__14913;var name = cljs.core.nth.call(null,vec__14915,0,null);var value = cljs.core.nth.call(null,vec__14915,1,null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__14916){var vec__14919 = p__14916;var tag = cljs.core.nth.call(null,vec__14919,0,null);var content = cljs.core.nthnext.call(null,vec__14919,1);if(!((function (){var or__3943__auto__ = (tag instanceof cljs.core.Keyword);if(or__3943__auto__)
{return or__3943__auto__;
} else
...
{}
var vec__14920 = cljs.core.re_matches.call(null,hiccups.runtime.re_tag,hiccups.runtime.as_str.call(null,tag));var _ = cljs.core.nth.call(null,vec__14920,0,null);var tag__$1 = cljs.core.nth.call(null,vec__14920,1,null);var id = cljs.core.nth.call(null,vec__14920,2,null);var class$ = cljs.core.nth.call(null,vec__14920,3,null);var tag_attrs = cljs.core.PersistentArrayMap.fromArray([new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),(cljs.core.truth_(class$)?class$.replace("."," "):null)], true);var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__14922 = hiccups.runtime.normalize_element.call(null,element);var tag = cljs.core.nth.call(null,vec__14922,0,null);var attrs = cljs.core.nth.call(null,vec__14922,1,null);var content = cljs.core.nth.call(null,vec__14922,2,null);if(cljs.core.truth_((function (){var or__3943__auto__ = content;if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
