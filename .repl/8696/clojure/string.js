...
{{
var G__14460 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14460;
continue;
}
} else
...
{var pred__14464 = cljs.core._EQ_;var expr__14465 = limit;if(pred__14464.call(null,1,expr__14465))
{return cljs.core.vector.call(null,s);
} else
{if(pred__14464.call(null,2,expr__14465))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__14467 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14468 = (limit__$1 - 1);
var G__14469 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14467;
limit__$1 = G__14468;
parts = G__14469;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14471 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14471))
{var replacement_14472 = temp__4090__auto___14471;buffer.append([cljs.core.str(replacement_14472)].join(''));
} else
{buffer.append(ch);
}
{
var G__14473 = (index + 1);
index = G__14473;
continue;
}
}
