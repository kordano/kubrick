...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14026 = 0;while(true){
var m_14027 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14027 == null))
{} else
{m_14027.call(null);
if((count_14026 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14028 = (count_14026 + 1);
count_14026 = G__14028;
continue;
}
} else
{}
