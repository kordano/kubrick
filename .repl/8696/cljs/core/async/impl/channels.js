...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14032 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t14032');

/**
* @constructor
*/
cljs.core.async.impl.channels.t14032 = (function (val,box,meta14033){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14032.cljs$lang$type = true;
cljs.core.async.impl.channels.t14032.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14032";
cljs.core.async.impl.channels.t14032.cljs$lang$ctorPrWriter = (function (this__6740__auto__,writer__6741__auto__,opt__6742__auto__){return cljs.core._write.call(null,writer__6741__auto__,"cljs.core.async.impl.channels/t14032");
});
cljs.core.async.impl.channels.t14032.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t14032.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14034){var self__ = this;
return self__.meta14033;
});
cljs.core.async.impl.channels.t14032.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14034,meta14033__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t14032(self__.val,self__.box,meta14033__$1));
});
cljs.core.async.impl.channels.__GT_t14032 = (function __GT_t14032(val__$1,box__$1,meta14033){return (new cljs.core.async.impl.channels.t14032(val__$1,box__$1,meta14033));
});
}
return (new cljs.core.async.impl.channels.t14032(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6743__auto__,writer__6744__auto__,opts__6745__auto__){return cljs.core._write.call(null,writer__6744__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6740__auto__,writer__6741__auto__,opt__6742__auto__){return cljs.core._write.call(null,writer__6741__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14035 = self__.takes.pop();if((taker_14035 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14035))
{var take_cb_14036 = cljs.core.async.impl.protocols.commit.call(null,taker_14035);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14036,taker_14035){
return (function (){return take_cb_14036.call(null,null);
});})(take_cb_14036,taker_14035))
);
} else
{}
{
