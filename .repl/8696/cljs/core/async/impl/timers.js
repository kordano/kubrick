...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14003 = 0;while(true){
if((i_14003 < arr.length))
{(arr[i_14003] = null);
{
var G__14004 = (i_14003 + 1);
i_14003 = G__14004;
continue;
}
} else
...
{var i_14010 = (self__.level + 1);while(true){
if((i_14010 <= (new_level + 1)))
{(update[i_14010] = self__.header);
{
...
{var i_14012 = 0;while(true){
if((i_14012 <= self__.level))
{var links_14013 = (update[i_14012]).forward;if(((links_14013[i_14012]) === x__$1))
{(links_14013[i_14012] = (x__$1.forward[i_14012]));
{
var G__14014 = (i_14012 + 1);
i_14012 = G__14014;
continue;
}
} else
{{
var G__14015 = (i_14012 + 1);
i_14012 = G__14015;
continue;
}
}
