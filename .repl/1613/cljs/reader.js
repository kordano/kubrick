...
{var x__19723__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.read_char[goog.typeOf(x__19723__auto__)]);if(or__3943__auto__)
...
{var x__19723__auto__ = (((reader == null))?null:reader);return (function (){var or__3943__auto__ = (cljs.reader.unread[goog.typeOf(x__19723__auto__)]);if(or__3943__auto__)
{return or__3943__auto__;
} else
...
cljs.reader.StringPushbackReader.cljs$lang$ctorPrWriter = (function (this__19654__auto__,writer__19655__auto__,opt__19656__auto__){return cljs.core._write.call(null,writer__19655__auto__,"cljs.reader/StringPushbackReader");
});
...
reader_error.cljs$lang$applyTo = (function (arglist__25223){
var rdr = cljs.core.first(arglist__25223);
var msg = cljs.core.rest(arglist__25223);
...
{{
var G__25224 = (function (){sb.append(ch);
return sb;
})();
var G__25225 = cljs.reader.read_char.call(null,rdr);
sb = G__25224;
ch = G__25225;
continue;
}
...
{{
var G__25226 = cljs.reader.read_char.call(null,rdr);
ch = G__25226;
continue;
}
} else
...
var G__25227 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__25227;
continue;
}
} else
...
var G__25228 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__25228;
continue;
}
}
...
{{
var G__25229 = (function (){buffer.append(ch);
return buffer;
})();
var G__25230 = cljs.reader.read_char.call(null,reader);
buffer = G__25229;
ch = G__25230;
continue;
}
...
{if(("\\" === ch))
{{
var G__25231 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__25232 = cljs.reader.read_char.call(null,reader);
buffer = G__25231;
ch = G__25232;
continue;
}
...
{{
var G__25233 = (function (){buffer.append(ch);
return buffer;
})();
var G__25234 = cljs.reader.read_char.call(null,reader);
buffer = G__25233;
ch = G__25234;
continue;
}
...
var o = cljs.reader.read.call(null,rdr,true,null,true);if((function (){var G__25236 = o;if(G__25236)
{if((function (){var or__3943__auto__ = (G__25236.cljs$lang$protocol_mask$partition0$ & 262144);if(or__3943__auto__)
{return or__3943__auto__;
} else
{return G__25236.cljs$core$IWithMeta$;
}
})())
{return true;
} else
{if((!G__25236.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__25236);
} else
{return false;
}
}
...
{{
var G__25237 = reader;
var G__25238 = eof_is_error;
var G__25239 = sentinel;
var G__25240 = is_recursive;
reader = G__25237;
eof_is_error = G__25238;
sentinel = G__25239;
is_recursive = G__25240;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__25241 = cljs.reader.read_comment.call(null,reader,ch);
var G__25242 = eof_is_error;
var G__25243 = sentinel;
var G__25244 = is_recursive;
reader = G__25241;
eof_is_error = G__25242;
sentinel = G__25243;
is_recursive = G__25244;
continue;
}
} else
{if(new cljs.core.Keyword(null,"else","else",1017020587))
...
{{
var G__25245 = reader;
var G__25246 = eof_is_error;
var G__25247 = sentinel;
var G__25248 = is_recursive;
reader = G__25245;
eof_is_error = G__25246;
sentinel = G__25247;
is_recursive = G__25248;
continue;
}
} else
{return res;
...
cljs.reader.parse_and_validate_timestamp = (function parse_and_validate_timestamp(s){var vec__25251 = cljs.core.re_matches.call(null,cljs.reader.timestamp_regex,s);var _ = cljs.core.nth.call(null,vec__25251,0,null);var years = cljs.core.nth.call(null,vec__25251,1,null);var months = cljs.core.nth.call(null,vec__25251,2,null);var days = cljs.core.nth.call(null,vec__25251,3,null);var hours = cljs.core.nth.call(null,vec__25251,4,null);var minutes = cljs.core.nth.call(null,vec__25251,5,null);var seconds = cljs.core.nth.call(null,vec__25251,6,null);var fraction = cljs.core.nth.call(null,vec__25251,7,null);var offset_sign = cljs.core.nth.call(null,vec__25251,8,null);var offset_hours = cljs.core.nth.call(null,vec__25251,9,null);var offset_minutes = cljs.core.nth.call(null,vec__25251,10,null);var v = vec__25251;if(cljs.core.not.call(null,v))
...
{var vec__25253 = temp__4090__auto__;var years = cljs.core.nth.call(null,vec__25253,0,null);var months = cljs.core.nth.call(null,vec__25253,1,null);var days = cljs.core.nth.call(null,vec__25253,2,null);var hours = cljs.core.nth.call(null,vec__25253,3,null);var minutes = cljs.core.nth.call(null,vec__25253,4,null);var seconds = cljs.core.nth.call(null,vec__25253,5,null);var ms = cljs.core.nth.call(null,vec__25253,6,null);var offset = cljs.core.nth.call(null,vec__25253,7,null);return (new Date((Date.UTC(years,(months - 1),days,hours,minutes,seconds,ms) - ((offset * 60) * 1000))));
} else
