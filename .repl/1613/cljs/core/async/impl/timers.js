...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__19654__auto__,writer__19655__auto__,opt__19656__auto__){return cljs.core._write.call(null,writer__19655__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_27198 = 0;while(true){
if((i_27198 < arr.length))
{(arr[i_27198] = null);
{
var G__27199 = (i_27198 + 1);
i_27198 = G__27199;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__19654__auto__,writer__19655__auto__,opt__19656__auto__){return cljs.core._write.call(null,writer__19655__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_27205 = (self__.level + 1);while(true){
if((i_27205 <= (new_level + 1)))
{(update[i_27205] = self__.header);
{
var G__27206 = (i_27205 + 1);
i_27205 = G__27206;
continue;
}
} else
...
{var i_27207 = 0;while(true){
if((i_27207 <= self__.level))
{var links_27208 = (update[i_27207]).forward;if(((links_27208[i_27207]) === x__$1))
{(links_27208[i_27207] = (x__$1.forward[i_27207]));
{
var G__27209 = (i_27207 + 1);
i_27207 = G__27209;
continue;
}
} else
{{
var G__27210 = (i_27207 + 1);
i_27207 = G__27210;
continue;
}
}
