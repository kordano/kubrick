...
{{
var G__27655 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27655;
continue;
}
} else
...
{var pred__27659 = cljs.core._EQ_;var expr__27660 = limit;if(pred__27659.call(null,1,expr__27660))
{return cljs.core.vector.call(null,s);
} else
{if(pred__27659.call(null,2,expr__27660))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__27662 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27663 = (limit__$1 - 1);
var G__27664 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__27662;
limit__$1 = G__27663;
parts = G__27664;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___27666 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___27666))
{var replacement_27667 = temp__4090__auto___27666;buffer.append([cljs.core.str(replacement_27667)].join(''));
} else
{buffer.append(ch);
}
{
var G__27668 = (index + 1);
index = G__27668;
continue;
}
}
