...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14016 = 0;while(true){
var m_14017 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14017 == null))
{} else
{m_14017.call(null);
if((count_14016 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14018 = (count_14016 + 1);
count_14016 = G__14018;
continue;
}
} else
{}
