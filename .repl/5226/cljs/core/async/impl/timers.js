...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6741__auto__,writer__6742__auto__,opt__6743__auto__){return cljs.core._write.call(null,writer__6742__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13993 = 0;while(true){
if((i_13993 < arr.length))
{(arr[i_13993] = null);
{
var G__13994 = (i_13993 + 1);
i_13993 = G__13994;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6741__auto__,writer__6742__auto__,opt__6743__auto__){return cljs.core._write.call(null,writer__6742__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14000 = (self__.level + 1);while(true){
if((i_14000 <= (new_level + 1)))
{(update[i_14000] = self__.header);
{
...
{var i_14002 = 0;while(true){
if((i_14002 <= self__.level))
{var links_14003 = (update[i_14002]).forward;if(((links_14003[i_14002]) === x__$1))
{(links_14003[i_14002] = (x__$1.forward[i_14002]));
{
