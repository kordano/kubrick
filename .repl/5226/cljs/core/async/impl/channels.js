...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14022 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t14022');

/**
* @constructor
*/
cljs.core.async.impl.channels.t14022 = (function (val,box,meta14023){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14022.cljs$lang$type = true;
cljs.core.async.impl.channels.t14022.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14022";
cljs.core.async.impl.channels.t14022.cljs$lang$ctorPrWriter = (function (this__6741__auto__,writer__6742__auto__,opt__6743__auto__){return cljs.core._write.call(null,writer__6742__auto__,"cljs.core.async.impl.channels/t14022");
});
cljs.core.async.impl.channels.t14022.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t14022.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14024){var self__ = this;
return self__.meta14023;
});
cljs.core.async.impl.channels.t14022.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14024,meta14023__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t14022(self__.val,self__.box,meta14023__$1));
});
cljs.core.async.impl.channels.__GT_t14022 = (function __GT_t14022(val__$1,box__$1,meta14023){return (new cljs.core.async.impl.channels.t14022(val__$1,box__$1,meta14023));
});
}
return (new cljs.core.async.impl.channels.t14022(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6744__auto__,writer__6745__auto__,opts__6746__auto__){return cljs.core._write.call(null,writer__6745__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6741__auto__,writer__6742__auto__,opt__6743__auto__){return cljs.core._write.call(null,writer__6742__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14025 = self__.takes.pop();if((taker_14025 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14025))
{var take_cb_14026 = cljs.core.async.impl.protocols.commit.call(null,taker_14025);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14026,taker_14025){
return (function (){return take_cb_14026.call(null,null);
});})(take_cb_14026,taker_14025))
);
} else
{}
{
