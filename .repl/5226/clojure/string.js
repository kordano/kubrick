...
{{
var G__14450 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14450;
continue;
}
} else
...
{var pred__14454 = cljs.core._EQ_;var expr__14455 = limit;if(pred__14454.call(null,1,expr__14455))
{return cljs.core.vector.call(null,s);
} else
{if(pred__14454.call(null,2,expr__14455))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__14457 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14458 = (limit__$1 - 1);
var G__14459 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14457;
limit__$1 = G__14458;
parts = G__14459;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14461 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14461))
{var replacement_14462 = temp__4090__auto___14461;buffer.append([cljs.core.str(replacement_14462)].join(''));
} else
{buffer.append(ch);
}
{
var G__14463 = (index + 1);
index = G__14463;
continue;
}
}
