...
hiccups.runtime.in_mode = (function in_mode(mode,f){var _STAR_html_mode_STAR_14895 = hiccups.runtime._STAR_html_mode_STAR_;try{hiccups.runtime._STAR_html_mode_STAR_ = mode;
return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_14895;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__14896){var vec__14898 = p__14896;var name = cljs.core.nth.call(null,vec__14898,0,null);var value = cljs.core.nth.call(null,vec__14898,1,null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__14899){var vec__14902 = p__14899;var tag = cljs.core.nth.call(null,vec__14902,0,null);var content = cljs.core.nthnext.call(null,vec__14902,1);if(!((function (){var or__3943__auto__ = (tag instanceof cljs.core.Keyword);if(or__3943__auto__)
{return or__3943__auto__;
} else
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__14905 = hiccups.runtime.normalize_element.call(null,element);var tag = cljs.core.nth.call(null,vec__14905,0,null);var attrs = cljs.core.nth.call(null,vec__14905,1,null);var content = cljs.core.nth.call(null,vec__14905,2,null);if(cljs.core.truth_((function (){var or__3943__auto__ = content;if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
