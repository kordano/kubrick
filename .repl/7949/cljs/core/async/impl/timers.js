...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6740__auto__,writer__6741__auto__,opt__6742__auto__){return cljs.core._write.call(null,writer__6741__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13986 = 0;while(true){
if((i_13986 < arr.length))
{(arr[i_13986] = null);
{
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6740__auto__,writer__6741__auto__,opt__6742__auto__){return cljs.core._write.call(null,writer__6741__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_13993 = (self__.level + 1);while(true){
if((i_13993 <= (new_level + 1)))
{(update[i_13993] = self__.header);
{
...
{var i_13995 = 0;while(true){
if((i_13995 <= self__.level))
{var links_13996 = (update[i_13995]).forward;if(((links_13996[i_13995]) === x__$1))
{(links_13996[i_13995] = (x__$1.forward[i_13995]));
{
