...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14015 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t14015');

/**
* @constructor
*/
cljs.core.async.impl.channels.t14015 = (function (val,box,meta14016){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14015.cljs$lang$type = true;
cljs.core.async.impl.channels.t14015.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14015";
cljs.core.async.impl.channels.t14015.cljs$lang$ctorPrWriter = (function (this__6740__auto__,writer__6741__auto__,opt__6742__auto__){return cljs.core._write.call(null,writer__6741__auto__,"cljs.core.async.impl.channels/t14015");
});
cljs.core.async.impl.channels.t14015.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t14015.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14017){var self__ = this;
return self__.meta14016;
});
cljs.core.async.impl.channels.t14015.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14017,meta14016__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t14015(self__.val,self__.box,meta14016__$1));
});
cljs.core.async.impl.channels.__GT_t14015 = (function __GT_t14015(val__$1,box__$1,meta14016){return (new cljs.core.async.impl.channels.t14015(val__$1,box__$1,meta14016));
});
}
return (new cljs.core.async.impl.channels.t14015(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14018 = self__.takes.pop();if((taker_14018 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14018))
{var take_cb_14019 = cljs.core.async.impl.protocols.commit.call(null,taker_14018);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14019,taker_14018){
return (function (){return take_cb_14019.call(null,null);
});})(take_cb_14019,taker_14018))
);
} else
{}
{
