...
{{
var G__14443 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14443;
continue;
}
} else
...
{var pred__14447 = cljs.core._EQ_;var expr__14448 = limit;if(pred__14447.call(null,1,expr__14448))
{return cljs.core.vector.call(null,s);
} else
{if(pred__14447.call(null,2,expr__14448))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__14450 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14451 = (limit__$1 - 1);
var G__14452 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14450;
limit__$1 = G__14451;
parts = G__14452;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14454 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14454))
{var replacement_14455 = temp__4090__auto___14454;buffer.append([cljs.core.str(replacement_14455)].join(''));
} else
{buffer.append(ch);
}
{
var G__14456 = (index + 1);
index = G__14456;
continue;
}
}
