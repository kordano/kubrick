...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__19659__auto__,writer__19660__auto__,opt__19661__auto__){return cljs.core._write.call(null,writer__19660__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_26943 = 0;while(true){
if((i_26943 < arr.length))
{(arr[i_26943] = null);
{
var G__26944 = (i_26943 + 1);
i_26943 = G__26944;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__19659__auto__,writer__19660__auto__,opt__19661__auto__){return cljs.core._write.call(null,writer__19660__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_26950 = (self__.level + 1);while(true){
if((i_26950 <= (new_level + 1)))
{(update[i_26950] = self__.header);
{
var G__26951 = (i_26950 + 1);
i_26950 = G__26951;
continue;
}
} else
...
{var i_26952 = 0;while(true){
if((i_26952 <= self__.level))
{var links_26953 = (update[i_26952]).forward;if(((links_26953[i_26952]) === x__$1))
{(links_26953[i_26952] = (x__$1.forward[i_26952]));
{
var G__26954 = (i_26952 + 1);
i_26952 = G__26954;
continue;
}
} else
{{
var G__26955 = (i_26952 + 1);
i_26952 = G__26955;
continue;
}
}
