...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t26972 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t26972');

/**
* @constructor
*/
cljs.core.async.impl.channels.t26972 = (function (val,box,meta26973){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t26972.cljs$lang$type = true;
cljs.core.async.impl.channels.t26972.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t26972";
cljs.core.async.impl.channels.t26972.cljs$lang$ctorPrWriter = (function (this__19659__auto__,writer__19660__auto__,opt__19661__auto__){return cljs.core._write.call(null,writer__19660__auto__,"cljs.core.async.impl.channels/t26972");
});
cljs.core.async.impl.channels.t26972.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t26972.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_26974){var self__ = this;
return self__.meta26973;
});
cljs.core.async.impl.channels.t26972.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_26974,meta26973__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t26972(self__.val,self__.box,meta26973__$1));
});
cljs.core.async.impl.channels.__GT_t26972 = (function __GT_t26972(val__$1,box__$1,meta26973){return (new cljs.core.async.impl.channels.t26972(val__$1,box__$1,meta26973));
});
}
return (new cljs.core.async.impl.channels.t26972(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__19662__auto__,writer__19663__auto__,opts__19664__auto__){return cljs.core._write.call(null,writer__19663__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__19659__auto__,writer__19660__auto__,opt__19661__auto__){return cljs.core._write.call(null,writer__19660__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_26975 = self__.takes.pop();if((taker_26975 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_26975))
{var take_cb_26976 = cljs.core.async.impl.protocols.commit.call(null,taker_26975);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_26976,taker_26975){
return (function (){return take_cb_26976.call(null,null);
});})(take_cb_26976,taker_26975))
);
} else
{}
{
