...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_26966 = 0;while(true){
var m_26967 = cljs.core.async.impl.dispatch.tasks.pop();if((m_26967 == null))
{} else
{m_26967.call(null);
if((count_26966 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__26968 = (count_26966 + 1);
count_26966 = G__26968;
continue;
}
} else
{}
