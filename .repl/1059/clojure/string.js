...
{{
var G__27400 = cljs.core.pop.call(null,v__$1);
v__$1 = G__27400;
continue;
}
} else
...
{var pred__27404 = cljs.core._EQ_;var expr__27405 = limit;if(pred__27404.call(null,1,expr__27405))
{return cljs.core.vector.call(null,s);
} else
{if(pred__27404.call(null,2,expr__27405))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__27407 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__27408 = (limit__$1 - 1);
var G__27409 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__27407;
limit__$1 = G__27408;
parts = G__27409;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___27411 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___27411))
{var replacement_27412 = temp__4090__auto___27411;buffer.append([cljs.core.str(replacement_27412)].join(''));
} else
{buffer.append(ch);
}
{
var G__27413 = (index + 1);
index = G__27413;
continue;
}
}
