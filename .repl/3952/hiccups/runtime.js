...
hiccups.runtime.in_mode = (function in_mode(mode,f){var _STAR_html_mode_STAR_15201 = hiccups.runtime._STAR_html_mode_STAR_;try{hiccups.runtime._STAR_html_mode_STAR_ = mode;
return f.call(null);
}finally {hiccups.runtime._STAR_html_mode_STAR_ = _STAR_html_mode_STAR_15201;
}});
/**
...
hiccups.runtime.render_attribute = (function render_attribute(p__15202){var vec__15204 = p__15202;var name = cljs.core.nth.call(null,vec__15204,0,null);var value = cljs.core.nth.call(null,vec__15204,1,null);if(value === true)
...
*/
hiccups.runtime.normalize_element = (function normalize_element(p__15205){var vec__15208 = p__15205;var tag = cljs.core.nth.call(null,vec__15208,0,null);var content = cljs.core.nthnext.call(null,vec__15208,1);if(!((function (){var or__3943__auto__ = (tag instanceof cljs.core.Keyword);if(or__3943__auto__)
{return or__3943__auto__;
} else
...
*/
hiccups.runtime.render_element = (function render_element(element){var vec__15211 = hiccups.runtime.normalize_element.call(null,element);var tag = cljs.core.nth.call(null,vec__15211,0,null);var attrs = cljs.core.nth.call(null,vec__15211,1,null);var content = cljs.core.nth.call(null,vec__15211,2,null);if(cljs.core.truth_((function (){var or__3943__auto__ = content;if(cljs.core.truth_(or__3943__auto__))
{return or__3943__auto__;
} else
