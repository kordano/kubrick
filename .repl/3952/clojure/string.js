...
{{
var G__14749 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14749;
continue;
}
} else
...
{var pred__14753 = cljs.core._EQ_;var expr__14754 = limit;if(pred__14753.call(null,1,expr__14754))
{return cljs.core.vector.call(null,s);
} else
{if(pred__14753.call(null,2,expr__14754))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__14756 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14757 = (limit__$1 - 1);
var G__14758 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__14756;
limit__$1 = G__14757;
parts = G__14758;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___14760 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___14760))
{var replacement_14761 = temp__4090__auto___14760;buffer.append([cljs.core.str(replacement_14761)].join(''));
} else
{buffer.append(ch);
}
{
var G__14762 = (index + 1);
index = G__14762;
continue;
}
}
