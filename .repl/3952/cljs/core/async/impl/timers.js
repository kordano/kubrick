...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__6744__auto__,writer__6745__auto__,opt__6746__auto__){return cljs.core._write.call(null,writer__6745__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14292 = 0;while(true){
if((i_14292 < arr.length))
{(arr[i_14292] = null);
{
var G__14293 = (i_14292 + 1);
i_14292 = G__14293;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__6744__auto__,writer__6745__auto__,opt__6746__auto__){return cljs.core._write.call(null,writer__6745__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_14299 = (self__.level + 1);while(true){
if((i_14299 <= (new_level + 1)))
{(update[i_14299] = self__.header);
{
var G__14300 = (i_14299 + 1);
i_14299 = G__14300;
continue;
}
} else
...
{var i_14301 = 0;while(true){
if((i_14301 <= self__.level))
{var links_14302 = (update[i_14301]).forward;if(((links_14302[i_14301]) === x__$1))
{(links_14302[i_14301] = (x__$1.forward[i_14301]));
{
var G__14303 = (i_14301 + 1);
i_14301 = G__14303;
continue;
}
} else
{{
var G__14304 = (i_14301 + 1);
i_14301 = G__14304;
continue;
}
}
