...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14321 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t14321');

/**
* @constructor
*/
cljs.core.async.impl.channels.t14321 = (function (val,box,meta14322){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14321.cljs$lang$type = true;
cljs.core.async.impl.channels.t14321.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14321";
cljs.core.async.impl.channels.t14321.cljs$lang$ctorPrWriter = (function (this__6744__auto__,writer__6745__auto__,opt__6746__auto__){return cljs.core._write.call(null,writer__6745__auto__,"cljs.core.async.impl.channels/t14321");
});
cljs.core.async.impl.channels.t14321.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t14321.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14323){var self__ = this;
return self__.meta14322;
});
cljs.core.async.impl.channels.t14321.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14323,meta14322__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t14321(self__.val,self__.box,meta14322__$1));
});
cljs.core.async.impl.channels.__GT_t14321 = (function __GT_t14321(val__$1,box__$1,meta14322){return (new cljs.core.async.impl.channels.t14321(val__$1,box__$1,meta14322));
});
}
return (new cljs.core.async.impl.channels.t14321(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__6747__auto__,writer__6748__auto__,opts__6749__auto__){return cljs.core._write.call(null,writer__6748__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__6744__auto__,writer__6745__auto__,opt__6746__auto__){return cljs.core._write.call(null,writer__6745__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_14324 = self__.takes.pop();if((taker_14324 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14324))
{var take_cb_14325 = cljs.core.async.impl.protocols.commit.call(null,taker_14324);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14325,taker_14324){
return (function (){return take_cb_14325.call(null,null);
});})(take_cb_14325,taker_14324))
);
} else
{}
{
