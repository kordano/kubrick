...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14315 = 0;while(true){
var m_14316 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14316 == null))
{} else
{m_14316.call(null);
if((count_14315 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14317 = (count_14315 + 1);
count_14315 = G__14317;
continue;
}
} else
{}
